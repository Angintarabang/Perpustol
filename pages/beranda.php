<div id="content">
    <div id="beranda-container">
        ...
        <h1 id="beranda-judul">SELAMAT DATANG DI PERPUSTAKAAN CHAOS YOHANES</h1>
        <p id="beranda-konten">
            "Di sini, kekacauan pengetahuan diatur menjadi harmoni yang elegan. Tempat di mana buku adalah harta, dan setiap halaman menceritakan kisah baru."
        </p>

        <!-- Pastikan Anda sudah meletakkan foto di folder images/ -->
